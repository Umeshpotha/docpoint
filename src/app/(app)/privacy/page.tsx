    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 text-white p-6">
      ...
      <div className="container mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-4">Data Collection</h2>
        ...
        {/* Data Usage Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-4">How We Use Your Data</h2>
          <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
            <p className="text-gray-300 text-lg mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-4">Data Integrity and Security</h2>
          <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
            <p className="text-gray-300 text-lg mb-4">
            ...
            <ul className="list-disc list-inside text-gray-400">
              <li>
                <span className="font-semibold">Encryption:</span> All data is encrypted both in transit and at rest using industry-standard encryption protocols (AES-256).
              </li>
              <li>
                <span className="font-semibold">Access Control:</span> Only authorized personnel have access to sensitive data.
              </li>
              <li>
                <span className="font-semibold">Regular Audits:</span> We regularly review and audit our security practices to ensure compliance with privacy standards.
              </li>
              <li>
                <span className="font-semibold">Data Minimization:</span> We only collect data that is necessary for the provision of services and retain it only for as long as needed.
              </li>
              <li>
                <span className="font-semibold">Two-Factor Authentication (2FA):</span> Users have the option to enable 2FA for an added layer of security.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-4">Data Sharing</h2>
          <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
            <p className="text-gray-300 text-lg mb-4">
            ...
            <ul className="list-disc list-inside text-gray-400">
              <li>
                <span className="font-semibold">With healthcare providers:</span> We share your data with doctors and hospitals to facilitate your appointments and medical services.
              </li>
              <li>
                <span className="font-semibold">For legal purposes:</span> We may disclose your data to comply with legal obligations or in response to a court order.
              </li>
              <li>
                <span className="font-semibold">With your consent:</span> We will always seek your permission before sharing your data with third parties for purposes not outlined in this policy.
              </li>
            </ul>
          </div>
        </section>
        ...
        {/* Your Rights Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-4">Your Rights</h2>
          <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
            <p className="text-gray-300 text-lg mb-4">
